...
`dmdprices` provides price lookups against the NHS Dictionary of Medicines and Devices (dm+d). A bundled dataset (Week 15 2026) is included so no setup is needed for immediate use.
...
Medicines and Devices (dm+d)**, Week 15 2026 (06 April 2026), published by
