...
Now inflate across the available data. The NHS CII now covers up to 2024/25 (the latest, provisional, year from the PSSRU 2025 manual). For years beyond the published data, such as 2025/26, you still need to apply your own estimate:
