...
> Medicine prices were obtained from the NHS dm+d (Week 15 2026) via the dmdprices R package. Drug Tariff prices (pence) were used where available; NHS Indicative prices were used as fallback. Historical costs were adjusted to 2024/25 prices using the NHS Cost Inflation Index (Jones et al., 2026, Unit Costs of Health and Social Care 2025 Manual, https://doi.org/10.22024/UniKent/01.02.115569).
