...
A **bundled dataset** (Week 15 2026, 06 April 2026) is included — no
...
- [**dm+d Price
  ...
  matching
- [**dm+d Dose
  Optimiser**](https://w-hardy.github.io/dmdprices/articles/apps.html#dmd-dose-optimiser)
  — find the cheapest / fewest-item AMPP combinations that deliver a
  target dose
- [**NHS CII Cost
...
Medicines and Devices (dm+d)**, Week 15 2026 release (06 April 2026),
...
NHS CII rates are from Jones et al. (2026), [*Unit Costs of Health and
Social Care 2025
Manual*](https://doi.org/10.22024/UniKent/01.02.115569), published by
